...
<style>
    ...
    /* Animated gradient background (Faded Green) */
    .bg-animation {
        position: fixed;
        width: 100%;
        height: 100%;
        ...
        <div class="col-md-8">
            <div class="card-body">
                ...
                <div class="text-center">
                    <p class="action-btn" style="background: transparent; box-shadow:none; cursor: default;">
                        MIGUA FABRICATORS MANAGEMENT SYSTEMS
                    </p>

                    <div class="d-flex flex-column align-items-center">
                        <a href="{{ route('attendance') }}" class="action-btn">
                            📅 Mark weekly attendance
                        </a>

                        <a href="{{ route('advance') }}" class="action-btn">
                            💰 Record salary advances
                        </a>

                        <a href="{{ route('attendance.summary') }}" class="action-btn">
            ...
            <div class="card">
                ...
                <div class="card-body d-flex justify-content-between">
                    ...
                    <a href="{{ route('password.change') }}" class="btn btn-outline-dark">
                        Change Password
                    </a>
                </div>
            </div>
